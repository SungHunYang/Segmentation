from network.architecture.deeplab_utils import IntermediateLayerGetter
from network.architecture.deeplab_extra import DeepLabHead, DeepLabHeadV3Plus, DeepLabV3
from network.backbone import resnet, mobilenetv2, hrnetv2, xception

# net = deeplab.__dict__[model_name](num_classes=1, output_stride=8).to(device)
# model_name: deeplabv3plus_{}/resnet50, mobilenet...
